...
export const categoryPages: Record<string, CategoryPageData> = {
  explore: {
    slug: "explore", eyebrow: "The knowledge map", title: "Explore the Atlas", description: "A structured starting point for geography, exam preparation, language, research and the ideas connecting them.", topics: [
      topic("bcs", "BCS Preparation", "Exam intelligence", "Build a clear path through the syllabus with focused study domains.", "/bcs"),
      topic("geography", "Geography", "Spatial knowledge", "Maps, regions, physical systems and the forces shaping place.", "/geography"),
      topic("international-affairs", "International Affairs", "Global perspective", "Events, institutions and ideas that connect the world.", "/international-affairs"),
      topic("english", "English & IELTS", "Language lab", "Sharper language, richer vocabulary and exam-ready communication.", "/english"),
      topic("research", "Research", "Field notes", "A home for questions, methods, GIS and work in progress.", "/research"),
  ...
  about: { slug: "about", eyebrow: "The idea behind the Atlas", title: "About Sajib Atlas", description: "Sajib Atlas is a personal knowledge platform for learning across geography, BCS preparation, international affairs, English, science and research.", topics: [topic("purpose", "A connected system", "Why it exists", "Knowledge becomes more useful when ideas can be found, revisited and connected.", "/about"), topic("approach", "Structured learning", "How it grows", "The platform is being shaped around clear domains, useful notes and steady practice.", "/about")], nextTitle: "Still being mapped", nextDescription: "Sajib Atlas is an evolving project. New notes, tools and connections will take shape as the knowledge system grows.", },
};

export const nestedPages: Record<string, CategoryPageData> = {
  "bcs/bangladesh-affairs": { slug: "bangladesh-affairs", eyebrow: "BCS / national context", title: "Bangladesh Affairs", description: "Build context around the history, society, economy and identity of Bangladesh.", parentHref: "/bcs", parentLabel: "BCS Preparation", topics: [topic("history", "History & Liberation", "Foundations", "Key periods, movements and milestones in Bangladesh's story.", "/bcs/bangladesh-affairs"), topic("economy", "Economy & Development", "Current structure", "The sectors, indicators and challenges shaping national development.", "/bcs/bangladesh-affairs"), topic("constitution", "Constitution & State", "Civic knowledge", "Institutions, rights and the framework of public life.", "/bcs/bangladesh-affairs")], nextTitle: "Build a national picture", nextDescription: "These topics will become concise, revision-friendly explainers with timelines and key facts." },
  "bcs/international-affairs": { slug: "international-affairs", eyebrow: "BCS / global perspective", title: "International Affairs", description: "Connect global events to institutions, geography, history and policy.", parentHref: "/bcs", parentLabel: "BCS Preparation", topics: [topic("diplomacy", "Diplomacy & Relations", "Core concepts", "The language and practice of states working across borders.", "/bcs/international-affairs"), topic("organizations", "International Organizations", "Institutions", "The roles and structures behind global cooperation.", "/bcs/international-affairs")], nextTitle: "Read beyond the headline", nextDescription: "Briefings and revision prompts will make major international themes easier to revisit." },
  "bcs/geography-environment": { slug: "geography-environment", eyebrow: "BCS / spatial knowledge", title: "Geography & Environment", description: "Study the physical systems, resources and environmental questions that shape Bangladesh and the world.", parentHref: "/bcs", parentLabel: "BCS Preparation", topics: [topic("physical-systems", "Physical Systems", "Earth science", "Climate, landforms, rivers and the forces shaping landscapes.", "/bcs/geography-environment"), topic("resources", "Resources & Risk", "Applied geography", "Natural resources, hazards and the choices behind resilience.", "/bcs/geography-environment")], nextTitle: "Think in systems", nextDescription: "Maps, diagrams and short concept notes will turn broad geography into connected recall." },
  "bcs/english": { slug: "english", eyebrow: "BCS / language lab", title: "English", description: "A focused space for the grammar, vocabulary and comprehension needed for BCS preparation.", parentHref: "/bcs", parentLabel: "BCS Preparation", topics: [topic("grammar", "Grammar", "Structure", "Usage and sentence patterns for precise answers.", "/english/grammar"), topic("vocabulary", "Vocabulary", "Word power", "High-value words learned through context and repetition.", "/english/vocabulary")], nextTitle: "Practice with precision", nextDescription: "Short drills and revision lists will make language work easier to fit into a study day." },
  "bcs/bangla": { slug: "bangla", eyebrow: "BCS / language & literature", title: "Bangla", description: "Explore Bangla language, literature and the cultural foundations of Bangladesh.", parentHref: "/bcs", parentLabel: "BCS Preparation", topics: [topic("language", "Bangla Language", "Usage", "Grammar, usage and the structure of Bangla expression.", "/bcs/bangla"), topic("literature", "Bangla Literature", "Culture", "Writers, movements and works that shape the literary tradition.", "/bcs/bangla")], nextTitle: "A richer reading list", nextDescription: "This section will grow into concise author notes, literary timelines and practice prompts." },
  "bcs/science-ict": { slug: "science-ict", eyebrow: "BCS / future signals", title: "Science & ICT", description: "Build practical understanding of core science and the digital systems shaping everyday life.", parentHref: "/bcs", parentLabel: "BCS Preparation", topics: [topic("general-science", "General Science", "Core concepts", "The essential ideas behind the natural world and human health.", "/bcs/science-ict"), topic("ict", "ICT & Digital Systems", "Technology", "Networks, information and the tools transforming society.", "/bcs/science-ict")], nextTitle: "Concepts you can use", nextDescription: "Future notes will pair short explanations with diagrams, examples and practice questions." },
